...
class BrowserDetection
{
    ...
    public function __toString()
    {
        ...
        $values[] = array('label' => 'Platform is 64-bit?', 'value' => $this->is64bitPlatform() ? 'Yass Boo!' : 'Nah Bra!');
        $values[] = array('label' => 'Is Mobile?', 'value' => $this->isMobile() ? 'Yass Boo!' : 'Nah Bro!');
        ...
        foreach ($values as $currVal) {
           $result .= '| ' .$currVal['label']. ': >> [+ ' . $currVal['value'] . ' +]' . PHP_EOL;
        }
        return $result;
    }
    //--- PUBLIC MEMBERS -----------------------------------------------------------------------------------------------
